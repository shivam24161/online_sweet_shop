  ...
  return (
    <>
                    ...
                    <div className="flip-card-inner">
                        ...
                        <h4 className='refer'>Coupon Code: <span style={{color:"green"}}>ENJOY60</span></h4>
                    ...
                    <div className="flip-card-inner">
                        ...
                        <img src="https://www.pngitem.com/pimgs/m/123-1232870_30-discount-0-hd-png-download.png" alt="Avatar" style={{width:"200px",height:"200px"}}/>
                        </div>
                        <div className="flip-card-back">
                        <img src="https://png.pngtree.com/png-clipart/20220102/original/pngtree-happy-hour-specials-lettering-png-image_6989362.png" alt="Avatar" style={{width:"200px",height:"200px"}}/>
                    ...
                    <div className="flip-card-inner mt-5">
                        ...
                        <img src="./offer.png" alt="Avatar" style={{width:"200px",height:"200px"}}/>
                        </div>
                        <div className="flip-card-back">
                        <img src="https://png.pngtree.com/png-clipart/20220510/original/pngtree-special-offer-50-off-sale-and-discount-banner-png-image_7694958.png" alt="Avatar" style={{width:"200px",height:"200px"}}/>
                        <button className="ordernow_btn">Order Now</button>
                        </div>
                    </div>
                    </div>
